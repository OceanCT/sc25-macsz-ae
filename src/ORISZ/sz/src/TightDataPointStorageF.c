...
void print_TightDataPointStorageF(TightDataPointStorageF *this) {
    printf("printing TightDataPointStorageF ...\n");
	if (this == NULL) {
        printf("TightDataPointStorageF is NULL\n");
        return;
    }

    printf("dataSeriesLength: %zu\n", this->dataSeriesLength);
    printf("exactDataNum: %zu\n", this->exactDataNum);
    printf("rtypeArray_size: %zu\n", this->rtypeArray_size);
    printf("typeArray_size: %zu\n", this->typeArray_size);
    printf("leadNumArray_size: %zu\n", this->leadNumArray_size);
    printf("exactMidBytes_size: %zu\n", this->exactMidBytes_size);
    printf("residualMidBits_size: %zu\n", this->residualMidBits_size);
    printf("pwrErrBoundBytes_size: %d\n", this->pwrErrBoundBytes_size);
    printf("raBytes_size: %zu\n", this->raBytes_size);
}
...
{
	// print_TightDataPointStorageF(tdps);
	size_t i, k = 0; 
	unsigned char dsLengthBytes[8];
